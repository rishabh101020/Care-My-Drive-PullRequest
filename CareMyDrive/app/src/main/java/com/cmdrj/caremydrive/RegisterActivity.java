...
//                mLastClickTime = SystemClock.elapsedRealtime();
                ...
                if (!(register_Name_TIET.getText().toString().trim().equals("")) && !(register_Email_TIET.getText().toString().trim().equals("")) && AddressGeoPoint != null ) {
                    ...
                    {
                        RecVewClient client = new RecVewClient(fUser.getUid(), register_Name_TIET.getText().toString().trim(), fUser.getPhoneNumber(), register_Email_TIET.getText().toString().trim(), AddressGeoPoint, Address, City, State, Country, Pincode);
                        ...
                        if(baos == null)
                        {
                            ...
                            fStore.collection("Clients").document(client.getID()).set(client).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
...
//
//                            fStore.collection("Size").document("Clients").update(map)
...
//                    fStore.collection("Clients").add(client)
