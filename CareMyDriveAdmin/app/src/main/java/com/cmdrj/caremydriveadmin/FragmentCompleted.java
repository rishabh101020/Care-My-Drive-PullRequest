...
public class FragmentCompleted extends Fragment {
    ...
    public static FragmentCompleted newInstance(String listBookingRef) {
...
//                                    Log.d("TAG" , "RishabhJain + " + document.toString());
                                    ...
                                    dReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                        ...
                                        public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                                            ...
                                            if (error != null) {
                                                Snackbar.make(RV_CompBook, "" + error, Snackbar.LENGTH_SHORT).show();
                                                return;
                                            }
...
//                            Snackbar.make(RV_CompBook, "No Completed Bookings.", Snackbar.LENGTH_SHORT).show();
