...
//    private String mParam2;
    ...
    public static FragmentInitiated newInstance(String listBookingRef) {
...
//                                    Log.d("TAG" , "RishabhJain + " + document.toString());
                                    ...
                                    dReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                        ...
                                        public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                                            ...
                                            if (error != null) {
                                                Snackbar.make(RV_InitBook, "" + error, Snackbar.LENGTH_SHORT).show();
                                                return;
                                            }
...
//        }
        ...
        else
        {
            ...
            cReference.whereIn("status",Arrays.asList(0,-2,-3)).addSnapshotListener(new EventListener<QuerySnapshot>() {
                @Override
                public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                    if (error != null) {
...
//                            Snackbar.make(RV_InitBook, "No Requested Bookings.", Snackbar.LENGTH_SHORT).show();
