        ...
        splash_screen_loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fUser == null) {
                    ...
                    List<AuthUI.IdpConfig> provider = Arrays.asList(new AuthUI.IdpConfig.PhoneBuilder().setAllowedCountries(Collections.singletonList("IN")).build());
...
//                    startLoginActivity();
                ...
                else
                {
                    ...
                    checkUserProgress(fUser.getUid());
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == AUTHUI_REQUEST_CODE)
        {
            if(resultCode == RESULT_OK)
            {
                ...
                if(fUser.getMetadata().getCreationTimestamp() == fUser.getMetadata().getLastSignInTimestamp()){
...
//                    Toast.makeText(this, "Welcome Back", Toast.LENGTH_SHORT).show();
    ...
    private void checkUserProgress(String uid){


        DocumentReference dReference = fStore.collection("Workshops").document(uid);
